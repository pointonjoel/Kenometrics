...
test_that("Sourcing txt data", {
  ...
  expect_equal(txt_cms,
               c(year = 1967.5, inv = 104512.428571429,
                 pop = 197380.880952381, price = 0.912635714285714,
                 linv = 11.5146321428571, lpop = 12.180785952381,
                 lprice = -0.093413280952381, t = 21.5,
                 invpc = 0.521338214285714, linvpc = -0.666155114285714)
  )
})
