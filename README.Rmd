...
<body>
  <ul>
    <li>
      <b>get\_data()</b> 
      <i>A single function to find and source data from a variety of sources (txt, Excel)</i></li>
    <li>
      <b>ttest()</b> 
...
## Importing data
When importing data, students may often be overwhelmed with the specifics needed when importing from a variety of sources. Having one function with txt and Excel integration simplies things further. 
