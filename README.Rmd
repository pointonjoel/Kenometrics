...
<body>
  <ul>
    <li>
      <b>get\_data()</b> 
      <i>A single function to find and source data from a variety of sources (FRED, txt, Excel)</i></li>
    <li>
      <b>ttest()</b> 
    ...
    <li>
      <b>make\_numeric()</b>
      <i>Make the data of numeric form, to allow to conversion from zoo to numeric (reversing the make_ts function).</i></li>
    <li>
      <b>ADF()</b>
...
#Check gp() and all_checks() - fix everything
#Finish website
